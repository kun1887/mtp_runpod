...
def vertex_tokenizer(
    max_seq_len: int = 128, add_eos: bool = True, add_bos: bool = True
):
    return VertexTokenizer(max_seq_len, add_eos, add_bos)


class VertexTokenizer(BaseTokenizer):
    """
    Simple character-level tokenizer for ASCII text.
    ...
    def __init__(
        self, max_seq_len: int = 128, add_eos: bool = True, add_bos: bool = True
    ):
        self.max_seq_len = max_seq_len
        self.pad_id = 0
        self.bos_id = 2
