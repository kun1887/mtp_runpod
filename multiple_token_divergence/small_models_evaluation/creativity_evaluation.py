import torch
from small_models_evaluation.pfa_evaluation import process_data
from small_models_evaluation.custom_generation import generate_from_recipe, generate_next_token_mtp_with_blending
...
def creativity_evaluation(recipe,
    ...
    This function processes a specialized small_models_evaluation dataset where samples are
    ...
    Args:
        ...
        num_datapoints (int, optional): The number of data points to process for
            the small_models_evaluation. Defaults to 500.
