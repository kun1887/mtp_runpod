...
from evaluation.pfa_evaluation import evaluate_language_generation_creativity
...
def pfa_creativity_evaluation(model_name, num_samples=1000, batch_size=100,
    ...
    results_path = f"evaluation/results/pfa_creativity_{model_id}_t_{temperature}_k_{top_k}_p_{top_p}_alpha_{alpha}_eq_{int(equal_entropy)}"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_samples", type=int, default=10, help="Number of sequences to generate for evaluation")
